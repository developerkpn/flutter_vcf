...
UnloadingPkDetailData _$UnloadingPkDetailDataFromJson(
  ...
  previousTankId: UnloadingPkDetailData._toInt(json['previous_tank_id']),
  previousTankCode: json['previous_tank_code'] as String?,
  previousTankName: json['previous_tank_name'] as String?,
  previousHoleId: UnloadingPkDetailData._toInt(json['previous_hole_id']),
  previousHoleCode: json['previous_hole_code'] as String?,
  previousHoleName: json['previous_hole_name'] as String?,
  ...
  durationMinutes: UnloadingPkDetailData._toInt(json['duration_minutes']),
...
Map<String, dynamic> _$UnloadingPkDetailDataToJson(
  ...
  'previous_tank_id': instance.previousTankId,
  'previous_tank_code': instance.previousTankCode,
  'previous_tank_name': instance.previousTankName,
  'previous_hole_id': instance.previousHoleId,
  'previous_hole_code': instance.previousHoleCode,
  'previous_hole_name': instance.previousHoleName,
...
UnloadingPkPhoto _$UnloadingPkPhotoFromJson(Map<String, dynamic> json) =>
    UnloadingPkPhoto(
      ...
      sequence: UnloadingPkPhoto._toInt(json['sequence']),
