...
LabPkRecord _$LabPkRecordFromJson(Map<String, dynamic> json) => LabPkRecord(
  ...
  remarksHold: json['remarks_hold'] as String?,
  remarksHoldRelab1: json['remarks_hold_relab_1'] as String?,
  remarksHoldRelab2: json['remarks_hold_relab_2'] as String?,
...
Map<String, dynamic> _$LabPkRecordToJson(LabPkRecord instance) =>
    <String, dynamic>{
      ...
      'remarks_hold': instance.remarksHold,
      'remarks_hold_relab_1': instance.remarksHoldRelab1,
      'remarks_hold_relab_2': instance.remarksHoldRelab2,
