...
class UnTiketManagerPOMEPage extends StatefulWidget {
  ...
  @override
  State<UnTiketManagerPOMEPage> createState() => _UnTiketManagerPOMEPageState();
}

class _UnTiketManagerPOMEPageState extends State<UnTiketManagerPOMEPage> {
...
// =============================================================================
// NESTED INPUT PAGE FOR MANAGER UNLOADING CHECK (POME)
// =============================================================================
