...
class SpTiketManagerPOMEPage extends StatefulWidget {
  final String userId;
  final String token;

  const SpTiketManagerPOMEPage({
    super.key,
  ...
  @override
  State<SpTiketManagerPOMEPage> createState() => _SpTiketManagerPOMEPageState();
}

class _SpTiketManagerPOMEPageState extends State<SpTiketManagerPOMEPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Manager Sampling POME"),
...
// =============================================================================
// NESTED INPUT PAGE FOR MANAGER SAMPLING CHECK (POME)
// =============================================================================
        ...
        try {
          ...
          if (data != null) {
            fallbackSamplingData = {
              'sediment_level': data.sediment_level,
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Operator Sampling Data Card (POME specific fields)
                  Card(
                    child: Padding(
                      padding: const EdgeInsets.all(12),
                      child: Column(
                        ...
                        children: [
                          ...
                          _readOnlyField(
                            "Sediment Level",
                            "${operatorSamplingData?['sediment_level'] ?? '-'}",
                          ),
                          _readOnlyField(
                            "pH Value",
                            "${operatorSamplingData?['ph_value'] ?? '-'}",
                          ),
                          _readOnlyField(
                            "Sampled By",
