...
class UnTiketManagerPKPage extends StatefulWidget {
  ...
  @override
  State<UnTiketManagerPKPage> createState() => _UnTiketManagerPKPageState();
}

class _UnTiketManagerPKPageState extends State<UnTiketManagerPKPage> {
...
// =============================================================================
// NESTED INPUT PAGE FOR MANAGER UNLOADING CHECK (PK)
// =============================================================================
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (primaryPhotoSources.isEmpty) {
        try {
          final unloadingRes = await api.getUnloadingPkDetail(
            "Bearer ${widget.token}",
            registrationId,
          );
